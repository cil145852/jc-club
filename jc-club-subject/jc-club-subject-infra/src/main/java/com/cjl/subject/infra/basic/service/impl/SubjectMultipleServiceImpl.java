...
import com.cjl.subject.infra.basic.mapper.SubjectMultipleDao;
...
public class SubjectMultipleServiceImpl implements SubjectMultipleService {
    ...
    @Override
    public List<SubjectMultiple> query(SubjectMultiple subjectMultiple) {
        return subjectMultipleDao.query(subjectMultiple);
    }
}
